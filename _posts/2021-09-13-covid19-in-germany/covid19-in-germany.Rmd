...
We can see from the figure that the number of ICU patients increased in line with the number of COVID19 cases. Likewise, the number of ICU patients fell as the vaccine rate increased.
